<template>
  <div class="admin-layout">
    <aside class="admin-sidebar">
      ...
      <el-menu :default-active="activeMenu" router class="admin-menu" :default-openeds="defaultOpeneds">
        <!-- 首页 -->
...
.admin-sidebar { width: 232px; background: #0d3a72; color: #fff; flex-shrink: 0; overflow-y: auto; }
